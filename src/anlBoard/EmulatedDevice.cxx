...
void
dunedaq::sspmodules::EmulatedDevice::Open(bool slowControlOnly)
{
...
void
dunedaq::sspmodules::EmulatedDevice::Close()
{
...
void
dunedaq::sspmodules::EmulatedDevice::DevicePurgeComm()
{
}

void
dunedaq::sspmodules::EmulatedDevice::DevicePurgeData()
{
...
void
dunedaq::sspmodules::EmulatedDevice::DeviceQueueStatus(unsigned int* numWords)
{
  (*numWords) = fEmulatedBuffer.size();
}

void
dunedaq::sspmodules::EmulatedDevice::DeviceReceive(std::vector<unsigned int>& data, unsigned int size)
{
...
void
dunedaq::sspmodules::EmulatedDevice::DeviceRead(unsigned int address, unsigned int* value)
{
  (void)address;
  (void)value;
}
...
void
dunedaq::sspmodules::EmulatedDevice::DeviceReadMask(unsigned int address, unsigned int mask, unsigned int* value)
{
  (void)address;
  (void)mask;
  (void)value;
...
void
dunedaq::sspmodules::EmulatedDevice::DeviceWrite(unsigned int address, unsigned int value)
{
...
void
dunedaq::sspmodules::EmulatedDevice::DeviceWriteMask(unsigned int address, unsigned int mask, unsigned int value)
{
  (void)address;
  (void)mask;
  (void)value;
...
void
dunedaq::sspmodules::EmulatedDevice::DeviceSet(unsigned int address, unsigned int mask)
{
  DeviceWriteMask(address, mask, 0xFFFFFFFF);
}

void
dunedaq::sspmodules::EmulatedDevice::DeviceClear(unsigned int address, unsigned int mask)
{
  DeviceWriteMask(address, mask, 0x00000000);
}

void
dunedaq::sspmodules::EmulatedDevice::DeviceArrayRead(unsigned int address, unsigned int size, unsigned int* data)
{
  (void)address;
  (void)size;
  (void)data;
...
void
dunedaq::sspmodules::EmulatedDevice::DeviceArrayWrite(unsigned int address, unsigned int size, unsigned int* data)
{
  (void)address;
  (void)size;
  (void)data;
...
void
dunedaq::sspmodules::EmulatedDevice::Start()
{
  // dune::DAQLogger::LogDebug("SSP_EmulatedDevice")<<"Creating emulator thread..."<<std::endl;
  fEmulatorShouldStop = false;
  fEmulatorThread =
    std::unique_ptr<std::thread>(new std::thread(&dunedaq::sspmodules::EmulatedDevice::EmulatorLoop, this));
}

void
dunedaq::sspmodules::EmulatedDevice::Stop()
{
...
void
dunedaq::sspmodules::EmulatedDevice::EmulatorLoop()
{
  ...
  while (!fEmulatorShouldStop) {
    ...
    unsigned long eventTimestamp =
      (std::chrono::duration_cast<std::chrono::duration<unsigned long, std::ratio<1, 150000000>>>(eventTime -
                                                                                                  runStartTime))
        .count(); // 150MHz clock // NOLINT(runtime/int)
