...
int connectToDevice(const char *ip) {
    int sockfd;
...
int sendReceive(int sockfd, Ctrl_Packet *tx, Ctrl_Packet *rx) {
...
int DeviceRead(int sockfd, unsigned int address, unsigned int *value) {
    Ctrl_Packet tx, rx;
