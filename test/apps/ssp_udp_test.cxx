...
int
connectToDevice(const char* ip, struct sockaddr_in* server_addr)
{
  int sockfd;
...
int
sendReceive(int sockfd, struct sockaddr_in* server_addr, Ctrl_Packet* tx, Ctrl_Packet* rx)
{
...
int
DeviceRead(int sockfd, struct sockaddr_in* server_addr, unsigned int address, unsigned int* value)
{
  Ctrl_Packet tx, rx;
